    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 to-black text-white">
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="bg-gradient-to-r from-zinc-800 to-zinc-900 rounded-2xl p-4 md:p-8 border border-zinc-700">
          ...
          {/* Optimized Chat Container for Tidio */}
          <div className="w-full h-96 md:h-[500px] lg:h-[600px] bg-zinc-700 rounded-xl border border-zinc-600 overflow-hidden">
            {/* Placeholder for Tidio Chat Widget */}
            <div className="w-full h-full flex flex-col items-center justify-center text-center p-6">
              <div className="text-4xl mb-4">💬</div>
              <div className="text-zinc-400 text-lg mb-4">
                Tidio chat widget will load here
              </div>
              <div className="bg-zinc-600 rounded-lg p-4 max-w-md">
                <p className="text-zinc-300 text-sm mb-2">
                  <strong>Optimized for mobile:</strong>
                </p>
                <ul className="text-zinc-400 text-xs space-y-1">
                  <li>• Full-width on all devices</li>
                  <li>• Responsive height (384px - 600px)</li>
                  <li>• Touch-friendly interface</li>
                  <li>• Easy message reading</li>
                </ul>
              </div>
            </div>
          </div>
